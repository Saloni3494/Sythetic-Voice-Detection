  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden bg-[#050505]">
      ...
      <motion.div style={{ opacity, scale }} className="relative z-10 h-full flex flex-col justify-between p-8 md:p-12 md:px-12 md:py-20">
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-2">01 — DETECTION</p>
          ...
          <br />
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-2"><span className="italic">AI-GENERATED SPEECH DETECTION</span></p>
        </motion.div>
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-2">02 — LOCALIZATION</p>
          <h2 className="font-sans text-4xl md:text-6xl lg:text-7xl font-light tracking-tight text-balance">
            SPEECH
            <br />
            <span className="italic">FORENSICS</span>
          </h2>
        </motion.div>
      </motion.div>
